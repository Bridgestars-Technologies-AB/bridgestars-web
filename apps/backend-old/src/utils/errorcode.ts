...
// }
//
// type UsernameMissing = {
//   message:string;
//   type:"UsernameTakeon";
//   hej: "hej"
// }
//
// type LoginErrors = UsernameTaken | UsernameMissing;
//
// function login() : Result<User, UsernameTaken | EmailTaken |..........>
//
// login().then(res => if(!res.ok) {
//   switch(res.type){
//
//   }
//    
...
Developers (custom app errors): >=9000 <=9999
  ...
  **/
  export enum CODE {
    ...
    InternalError = 9000, 
    //validation
    FieldValidationError = 9001,
    ImmutableField = 9002,
    RequiredField = 9003,

    InternalEmailSendError = 9004,
    Unauthorized = 9005, // when user is missing roles

    InvalidUsernameOrPassword = 9006, // when user is missing roles

    MissingArgument = 9007, // when cloud functions misses argument 
  }
