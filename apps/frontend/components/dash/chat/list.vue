            ...
            <div class="relative flex items-center group pl-1">
              ...
              <div class="flex flex-col w-full">
                <div class="flex items-center justify-between">
                  ...
                  <!-- Chat last update -->
                  <span
                    class="ml-2 text2 text-[12px] leading-[12px] dark:text-light text-dark"
                    >{{ getTime(c) }}</span
                  >
                  <span
                    class="i-material-symbols-arrow-forward-ios text-dark dark:text-light text-[16px] group-hover:translate-x-1 transition-transform break-words"
                  />
                </div>

                <!-- Message text -->
                <div class="w-[280px] h-[24px] overflow-hidden">
                  <!-- this is a hack to make the flexbox work -->
                  <span
                    class="ml-2 mt-1 text-[18px] leading-[18px] dark:text-light text-dark opacity-[80%]"
                    >{{ c?.latestMessage?.text }}</span
                  >
                </div>
              </div>
            </div>
